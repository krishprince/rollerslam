...
eq(_17890, _17893, _17896) :- functor(_17890, _17908, _17911), functor(_17893, _17923, _17926), (_17908 = _17923, _17911 = _17926 -> _17890 =.. [_17949|_17951], _17893 =.. [_17958|_17960], and_eq(_17951, _17960, _17896) ; _17896 = (0 #\= 0)).
neq(_18190, _18193) :- or_neq(exists, _18190, _18193).
neq(_18218, _18221, _18224) :- or_neq_c(exists, _18218, _18221, _18224).
neq_all(_18253, _18256) :- or_neq(forall, _18253, _18256).
neq_all(_18281, _18284, _18287) :- or_neq_c(forall, _18281, _18284, _18287).
or_neq(_18316, _18319, _18322) :- functor(_18319, _18334, _18337), functor(_18322, _18349, _18352), (_18334 = _18349, _18337 = _18352 -> _18319 =.. [_18375|_18377], _18322 =.. [_18384|_18386], or_neq(_18316, _18377, _18386, _18398), call(_18398) ; true).
or_neq_c(_18621, _18624, _18627, _18630) :- functor(_18624, _18643, _18646), functor(_18627, _18658, _18661), (_18643 = _18658, _18646 = _18661 -> _18624 =.. [_18684|_18686], _18627 =.. [_18693|_18695], or_neq(_18621, _18686, _18695, _18630) ; _18630 = (0 #= 0)).
or_neq(_18946, [], [], 0 #\= 0).
or_neq(_18989, [_18994|_18995], [_19000|_19001], _19004) :- or_neq(_18989, _18995, _19001, _19021), (_18989 = forall, var(_18994), \+ is_domain(_18994) -> (binding(_18994, _18995, _19001, _19060) -> _19004 = #\/(_19000 #\= _19060, _19021) ; _19004 = _19021) ; _19004 = #\/(_18994 #\= _19000, _19021)).
binding(_19335, [_19340|_19341], [_19346|_19347], _19350) :- _19335 == _19340 -> _19350 = _19346 ; binding(_19335, _19341, _19347, _19350).
and_eq([], [], 0 #= 0).
and_eq([_19440|_19441], [_19446|_19447], _19450) :- and_eq(_19441, _19447, _19464), _19450 = #/\(_19440 #= _19446, _19464).
or_and_eq([], 0 #\= 0).
or_and_eq([_19622|_19623], #\/(_19626, _19630)) :- (_19622 = eq(_19642, _19645) -> and_eq(_19642, _19645, _19626) ; _19622 = neq(_19642, _19645), or_neq(exists, _19642, _19645, _19626)), or_and_eq(_19623, _19630).
inst(_19860, _19863) :- \+ (term_variables(_19860, _19876), term_variables(_19863, _19887), bound_free(_19887, _19876, _19900, _19903), copy_term_vars(_19903, _19863, _19918), \+ (make_suspension('CHRfail', 1, _20095), insert_suspension(_19900, _20095, 2, suspend), last_suspension(_20103), _19860 = _19918, true, new_suspensions(_20103, []), kill_suspension(_20095))).
copy_fluent(_20131, _20134, _20137, _20140) :- term_variables(_20131, _20153), bound_free(_20153, [], _20172, _20168), copy_term_vars(_20168, [_20131, _20134], [_20137, _20140]).
bound_free([], _20325, _20325, []).
bound_free([_20345|_20346], _20349, _20352, _20355) :- bound_free(_20346, _20349, _20370, _20373), (is_domain(_20345) -> _20352 = [_20345|_20370], _20355 = _20373 ; _20352 = _20370, _20355 = [_20345|_20373]).
member(_20580, [_20580|_20585], _20585).
member(_20600, [_20605|_20606], [_20605|_20611]) :- member(_20600, _20606, _20611).
not_holds(A, B) :-
	'CHRgen_num'(C),
...
:- current_macro('CHRnot_holds_2' / 4, _22194, _22195, _22196) -> true ; define_macro('CHRnot_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRnot_holds_all_2' / 4, _25069, _25070, _25071) -> true ; define_macro('CHRnot_holds_all_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRduplicate_free_1' / 4, _25752, _25753, _25754) -> true ; define_macro('CHRduplicate_free_1' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRor_holds_2' / 4, _29157, _29158, _29159) -> true ; define_macro('CHRor_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRor_holds_3' / 4, _29983, _29984, _29985) -> true ; define_macro('CHRor_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_holds_2' / 4, _30560, _30561, _30562) -> true ; define_macro('CHRall_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_holds_3' / 4, _31707, _31708, _31709) -> true ; define_macro('CHRall_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_not_holds_3' / 4, _35050, _35051, _35052) -> true ; define_macro('CHRall_not_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_holds_3' / 4, _37699, _37700, _37701) -> true ; define_macro('CHRif_then_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_or_holds_3' / 4, _42290, _42291, _42292) -> true ; define_macro('CHRif_then_or_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_or_holds_4' / 4, _43135, _43136, _43137) -> true ; define_macro('CHRif_then_or_holds_4' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRcancel_2' / 4, _43937, _43938, _43939) -> true ; define_macro('CHRcancel_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRcancelled_2' / 4, _47080, _47081, _47082) -> true ; define_macro('CHRcancelled_2' / 4, tr_chr / 2, [write]).
