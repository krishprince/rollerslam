...
public enum SpriteKind {
    ...
    RED_PLAYER_WITH_BALL("rollerslam/display/gui/resources/pnb.png"),
    RED_PLAYER_GROUNDED("rollerslam/display/gui/resources/pnb.png"),
    
    //blue team
    BLUE_PLAYER("rollerslam/display/gui/resources/pwb.png"),
    BLUE_PLAYER_WITH_BALL("rollerslam/display/gui/resources/pwb.png"),
    BLUE_PLAYER_GROUNDED("rollerslam/display/gui/resources/pwb.png"),
