...
eq(_17384, _17387, _17390) :- functor(_17384, _17402, _17405), functor(_17387, _17417, _17420), (_17402 = _17417, _17405 = _17420 -> _17384 =.. [_17443|_17445], _17387 =.. [_17452|_17454], and_eq(_17445, _17454, _17390) ; _17390 = (0 #\= 0)).
neq(_17684, _17687) :- or_neq(exists, _17684, _17687).
neq(_17712, _17715, _17718) :- or_neq_c(exists, _17712, _17715, _17718).
neq_all(_17747, _17750) :- or_neq(forall, _17747, _17750).
neq_all(_17775, _17778, _17781) :- or_neq_c(forall, _17775, _17778, _17781).
or_neq(_17810, _17813, _17816) :- functor(_17813, _17828, _17831), functor(_17816, _17843, _17846), (_17828 = _17843, _17831 = _17846 -> _17813 =.. [_17869|_17871], _17816 =.. [_17878|_17880], or_neq(_17810, _17871, _17880, _17892), call(_17892) ; true).
or_neq_c(_18115, _18118, _18121, _18124) :- functor(_18118, _18137, _18140), functor(_18121, _18152, _18155), (_18137 = _18152, _18140 = _18155 -> _18118 =.. [_18178|_18180], _18121 =.. [_18187|_18189], or_neq(_18115, _18180, _18189, _18124) ; _18124 = (0 #= 0)).
or_neq(_18440, [], [], 0 #\= 0).
or_neq(_18483, [_18488|_18489], [_18494|_18495], _18498) :- or_neq(_18483, _18489, _18495, _18515), (_18483 = forall, var(_18488), \+ is_domain(_18488) -> (binding(_18488, _18489, _18495, _18554) -> _18498 = #\/(_18494 #\= _18554, _18515) ; _18498 = _18515) ; _18498 = #\/(_18488 #\= _18494, _18515)).
binding(_18829, [_18834|_18835], [_18840|_18841], _18844) :- _18829 == _18834 -> _18844 = _18840 ; binding(_18829, _18835, _18841, _18844).
and_eq([], [], 0 #= 0).
and_eq([_18934|_18935], [_18940|_18941], _18944) :- and_eq(_18935, _18941, _18958), _18944 = #/\(_18934 #= _18940, _18958).
or_and_eq([], 0 #\= 0).
or_and_eq([_19116|_19117], #\/(_19120, _19124)) :- (_19116 = eq(_19136, _19139) -> and_eq(_19136, _19139, _19120) ; _19116 = neq(_19136, _19139), or_neq(exists, _19136, _19139, _19120)), or_and_eq(_19117, _19124).
inst(_19354, _19357) :- \+ (term_variables(_19354, _19370), term_variables(_19357, _19381), bound_free(_19381, _19370, _19394, _19397), copy_term_vars(_19397, _19357, _19412), \+ (make_suspension('CHRfail', 1, _19589), insert_suspension(_19394, _19589, 2, suspend), last_suspension(_19597), _19354 = _19412, true, new_suspensions(_19597, []), kill_suspension(_19589))).
copy_fluent(_19625, _19628, _19631, _19634) :- term_variables(_19625, _19647), bound_free(_19647, [], _19666, _19662), copy_term_vars(_19662, [_19625, _19628], [_19631, _19634]).
bound_free([], _19819, _19819, []).
bound_free([_19839|_19840], _19843, _19846, _19849) :- bound_free(_19840, _19843, _19864, _19867), (is_domain(_19839) -> _19846 = [_19839|_19864], _19849 = _19867 ; _19846 = _19864, _19849 = [_19839|_19867]).
member(_20074, [_20074|_20079], _20079).
member(_20094, [_20099|_20100], [_20099|_20105]) :- member(_20094, _20100, _20105).
not_holds(A, B) :-
	'CHRgen_num'(C),
...
:- current_macro('CHRnot_holds_2' / 4, _21688, _21689, _21690) -> true ; define_macro('CHRnot_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRnot_holds_all_2' / 4, _24563, _24564, _24565) -> true ; define_macro('CHRnot_holds_all_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRduplicate_free_1' / 4, _25246, _25247, _25248) -> true ; define_macro('CHRduplicate_free_1' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRor_holds_2' / 4, _28651, _28652, _28653) -> true ; define_macro('CHRor_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRor_holds_3' / 4, _29477, _29478, _29479) -> true ; define_macro('CHRor_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_holds_2' / 4, _30054, _30055, _30056) -> true ; define_macro('CHRall_holds_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_holds_3' / 4, _31201, _31202, _31203) -> true ; define_macro('CHRall_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRall_not_holds_3' / 4, _34544, _34545, _34546) -> true ; define_macro('CHRall_not_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_holds_3' / 4, _37193, _37194, _37195) -> true ; define_macro('CHRif_then_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_or_holds_3' / 4, _41784, _41785, _41786) -> true ; define_macro('CHRif_then_or_holds_3' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRif_then_or_holds_4' / 4, _42629, _42630, _42631) -> true ; define_macro('CHRif_then_or_holds_4' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRcancel_2' / 4, _43431, _43432, _43433) -> true ; define_macro('CHRcancel_2' / 4, tr_chr / 2, [write]).
...
:- current_macro('CHRcancelled_2' / 4, _46574, _46575, _46576) -> true ; define_macro('CHRcancelled_2' / 4, tr_chr / 2, [write]).
