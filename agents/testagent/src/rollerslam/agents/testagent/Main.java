 ...
 *  
 */
package rollerslam.agents.testagent;

import java.rmi.AlreadyBoundException;
import java.rmi.RemoteException;

import rollerslam.agents.Agent;
import rollerslam.infrastructure.client.ServerImpl;
...
public class Main {
	...
	public static void main(String[] args) throws RemoteException,
		...
		ServerImpl.init(args[0]);

		ServerImpl server = ServerImpl.getInstance();
		TestAgent realAgent = new TestAgent(server.getSimulationAdmin()
				.getEnvironmentAgent());
