...
public class GameCanvas extends Canvas {
	...
	public GameCanvas() {
		...
		background = SpriteStore.get().getSprite(
				"rollerslam/display/gui/resources/field.png");
		pwb = SpriteStore.get().getSprite(
				"rollerslam/display/gui/resources/pwb.png");
		pnb = SpriteStore.get().getSprite(
				"rollerslam/display/gui/resources/pnb.png");
		b = SpriteStore.get().getSprite(
				"rollerslam/display/gui/resources/ball.png");
	}
			...
			public void run() {
				while (true) {
					...
					if (world != null) {
						...
						b.draw(g, translatex(world.ball.sx),
								translatey(world.ball.sy));
					}
